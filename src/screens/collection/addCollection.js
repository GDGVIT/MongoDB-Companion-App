...
export class AddCollection extends React.Component {
    ...
    addCollection = async () => {
        if(this.state.collectionName){
            ToastAndroid.show(this.state.collectionName, ToastAndroid.SHORT);
        }
        else{
    ...
    render() {
        return (
            <Container>
                <InputText placeholder="Collection Name" onChangeText={(collectionName) => this.setState({collectionName})}/>
